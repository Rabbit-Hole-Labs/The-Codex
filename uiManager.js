...
function createLinkElement(link, index, state) {
    ...
    div.innerHTML = `
        ...
        <div class="link-actions">
            <a href="${sanitizeHTML(link.url)}" target="_blank" class="visit-link">Visit</a>
            <button class="edit-button">Edit</button>
            <button class="delete-button">Delete</button>
        </div>
    `;

    div.querySelector('.edit-button').addEventListener('click', () => openEditModal(state, index));
    div.querySelector('.delete-button').addEventListener('click', () => deleteLink(state, index));
